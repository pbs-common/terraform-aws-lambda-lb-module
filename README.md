...
```hcl
github.com/pbs/terraform-aws-lambda-lb-module?ref=1.0.4
```
...
```hcl
module "lambda_lb" {
  source = "github.com/pbs/terraform-aws-lambda-lb-module?ref=1.0.4"
...
| <a name="module_lambda_permission"></a> [lambda\_permission](#module\_lambda\_permission) | github.com/pbs/terraform-aws-lambda-permission-module | 1.0.0 |
